...
def adult_afar(filename, AUs, GPU, max_frames, AU_Int, batch_size, PID, fill_value=0):
    _resolve_models_dir()
    print(filename)
...
if __name__ == "__main__":
    ...
    fg = adult_afar(r"D:\Codes\Pitt\2024\Ext PyAFAR\inp\LeftVideoSN003_comp.avi", ["au_1"], True, 1000, ["au_6"], 100, False)
